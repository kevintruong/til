...
If we write a multi-threaded program (more about that later) 
...
If a new malloc request for 2KB is executed (`malloc(2048)`), where should `malloc` reserve the memory? 
